...
const MainBody = () => {
  return (
    <main className="my-5">
      <header className="text-left p-5">
        <h2 className="text-[2rem] text-white font-serif">
      ...
      <section className="flex flex-wrap my-8 justify-center w-[75%] mx-auto">
        <img src={Walmart} alt="Walmart" className="py-2 px-2 h-9" />
        <img src={JPMorgan} alt="JP Morgan" className="py-2 px-2 h-9" />
        <img src={Visa} alt="Visa" className="py-2 px-2 h-9" />
        <img src={Tinder} alt="Tinder" className="py-2 px-2 h-9" />
        <img src={Samsung} alt="Samsung" className="py-2 px-2 h-9" />
        <img src={Verizon} alt="Verizon" className="py-2 px-2 h-9" />
      </section>

      <section className="my-10">
        <div className="m-4">
          <img src={Spense} alt="Spense" className="my-4" />
          <a href="" className="text-[1.8rem] text-left text-white font-serif">
            Spense.com →
          </a>
          <p className="mt-2font-sans text-gray text-[1rem]">
      ...
      <section className="my-10">
        <div className="m-4">
          <img src={YelpCamp} alt="YelpCamp" className="my-4" />
          <a href="" className="text-[1.8rem] text-left text-white font-serif">
            YelpCamp.com →
          </a>
          <p className="mt-2 font-sans text-gray text-[1rem]">
      ...
      <section className="mt-10 py-10 px-5 bg-dark-gray mx-auto">
        <h1 className="text-white font-serif text-[1.9rem]">
          A co-founder at one of the world's largest communities.
        </h1>
        <p className="font-sans text-gray text-[1rem]">
      ...
      <section className="pt-10 pb-5 px-5 mx-auto bg-black">
        <h1 className="text-white font-serif text-[1.9rem]">
          Interested in working with me?
        </h1>
        <p className="font-sans text-gray text-[1rem] pb-2">
